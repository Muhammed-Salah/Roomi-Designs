        ...
        <div class="row d-flex mt-5 contact-info">
          ...
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span> Kappil House,<br> Chemmaniyode Post,<br> Malappuram DT,<br> Kerala, 679325</p>
	          </div>
          </div>
          ...
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:roomidesigns@gmail.com">roomidesigns@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website</span> <a href="#">www.roomidesigns.com</a></p>
	          </div>
          </div>
        </div>
      </div>
